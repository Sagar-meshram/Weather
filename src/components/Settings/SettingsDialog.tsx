...
// Updated Gemini 2.5 models incorporated here
    ...
    geminiModels: [
      {
        id: "gemini-2.5-pro",
        name: "Gemini 2.5 Pro",
        description: "Most advanced reasoning and multi-modal capability",
      },
      {
        id: "gemini-2.5-flash",
        name: "Gemini 2.5 Flash",
        description: "Fast, cost-effective model for general multi-modal extraction",
      },
      {
        id: "gemini-2.5-flash-lite",
        name: "Gemini 2.5 Flash Lite",
        description: "Highly efficient, optimized for throughput and cost",
      },
    ],
    anthropicModels: [
      {
    ...
    geminiModels: [
      {
        id: "gemini-2.5-pro",
        name: "Gemini 2.5 Pro",
        description: "Advanced reasoning and coding capabilities with extended context",
      },
      {
        id: "gemini-2.5-flash",
        name: "Gemini 2.5 Flash",
        description: "Optimized for speed and cost-effective coding generation",
      },
      {
        id: "gemini-2.5-flash-lite",
        name: "Gemini 2.5 Flash Lite",
        description: "Highly cost-efficient model for coding solutions with throughput focus",
      },
    ],
    anthropicModels: [
      {
    ...
    geminiModels: [
      {
        id: "gemini-2.5-pro",
        name: "Gemini 2.5 Pro",
        description: "Superior code analysis and debugging with deep reasoning",
      },
      {
        id: "gemini-2.5-flash",
        name: "Gemini 2.5 Flash",
        description: "Fast and efficient debugging model",
      },
      {
        id: "gemini-2.5-flash-lite",
        name: "Gemini 2.5 Flash Lite",
        description: "Cost-effective and high-throughput debugging",
      },
    ],
    anthropicModels: [
      {
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription className="text-white/70">
            Configure your API key and model preferences. You'll need your own API key
