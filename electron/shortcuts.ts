...
export class ShortcutsHelper {
  ...
  public registerGlobalShortcuts(): void {
    ...
    globalShortcut.register("CommandOrControl+R", () => {
      console.log(
        "Command + R pressed. Resetting window position and clearing queues..."
      )

      // Reset window position to center/default
      ...
      console.log("Cleared queues and reset window position.")
